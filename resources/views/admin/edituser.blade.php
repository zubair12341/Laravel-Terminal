...
<div class="px-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="p-2">
                                    <form class="form-horizontal" method="post" role="form" action="{{route('admin.user.update')}}">
                                        @csrf
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="email" value="{{$user->email}}" id="example-email" name="email"
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="form-check form-switch mx-3 mt-2">
                                                <input @if($user->hasRole('payment')) checked  @endif class="form-check-input" name="access" type="checkbox"
                                            ...
                                            <div class="form-check form-switch mx-3 mt-2">
                                                <input @if($user->hasRole('user')) checked  @endif  class="form-check-input" name="access2" type="checkbox"
                                                    id="flexSwitchCheckCheckedDisabled">
                                                <label class="form-check-label" for="flexSwitchCheckCheckedDisabled">
                                                    Give access to create
                                                    payment and users.</label>
                                            </div>

                                            <div class="form-check form-switch mx-3 mt-2">
                                                <input @if($user->hasRole('all_access')) checked  @endif  class="form-check-input" name="access3" type="checkbox"
                                        ...
                                        <div class="row">
                                            ...
                                            class="btn btn-primary waves-effect waves-light mb-3 mt-4"><i
                                                class="mdi mdi-account-plus me-1"></i> Edit User</a>
                                            </div>
                                        </div>
    ...
    {{-- <style>
        ...
        input[type="radio"]:checked+.toggle-label::before {
