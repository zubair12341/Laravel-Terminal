...
<body>
    ...
    <div class="layout-wrapper">
        ...
        <div class="main-menu">
            ...
            <div class="logo-box">
                <!-- Brand Logo Light -->
                <a href="{{ route('user.index') }}" class="logo-light">
                ...
                <!-- Brand Logo Dark -->
                <a href="{{ route('user.index') }}" class="logo-dark">
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    @role('all_access')
                        <li class="menu-item">
                            <a href="{{ route('user.users') }}" class="menu-link waves-effect waves-light">
                    ...
                    @endrole
                    <li class="menu-item">
                        <a href="{{ route('user.customer') }}" class="menu-link waves-effect waves-light">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('user.invoice') }}" class="menu-link waves-effect waves-light">
                    ...
                    @role('user')
                        <li class="menu-item">
                            <a href="{{ route('user.addInvoice') }}" class="menu-link waves-effect waves-light">
